...
function updateParamLabels(description, param1Input, param2Input, param3Input, param4Input) {
    ...
    switch (description) {
        ...
        case 'FillFromTopCoefficientCountry':
            param1Input.title = 'Target Advancement';
            param1Input.placeholder = 'Enter Target Advancement';
            param2Input.title = 'Position';
            param2Input.placeholder = 'Enter Position';
            param3Input.title = 'Max Teams from One Country';
            param3Input.placeholder = 'Enter Max Teams from One Country';
            param4Input.title = 'Max Total Teams';
            param4Input.placeholder = 'Enter Max Total Teams';
            break;
